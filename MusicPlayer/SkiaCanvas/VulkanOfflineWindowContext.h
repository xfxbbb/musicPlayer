...
namespace sk_app {
    ...
    class VulkanOfflineWindowContext : public WindowContext {
    public:
        ...
        VulkanOfflineWindowContext(const DisplayParams&, CreateVkSurfaceFn, CanPresentFn, PFN_vkGetInstanceProcAddr,
            PFN_vkGetDeviceProcAddr, DrawCallBack);

        ~VulkanOfflineWindowContext() override;
